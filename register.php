  ...
  <style>
      /*body{
        ...
        background-size: cover;
         ...
         background-image : "img/driver.jpg";
      }*/
      input#psw{
    width:300px;
...
.invalid:before {
  ...
  content: "✖";
    ...
    <h1 id="fam">JOIN OUR SMART VEHICLES!</h1>
 <div class="main">
        ...
        <form id="register" action="register.php" method="POST">    
            ...
            <input type="submit" class="btnn"  value="REGISTER" name="regs" style="background-color: #0dff00;color: white">
